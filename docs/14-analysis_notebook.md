...
**associations_before_minimum_observations:** BC - cCRE association file before filtering for a minimal number of unique BC-cCRE observations. Format is identical to final_df
...
|----|------------|------------|---------------|--------------------------|-------------|------------------|------------|
|cCRE ID 1|DNA read count across all replicates |RNA read count across all replicates|cCRE activity|log RNA/DNA ratio across all replicates|mad score p-value|activity statistic|
|cCRE ID 2|DNA read count across all replicates |RNA read count across all replicates|cCRE activity|log RNA/DNA ratio across all replicates|mad score p-value|activity statistic|adjusted p-value after FDR|
