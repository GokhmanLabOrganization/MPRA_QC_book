...
|cCRE ID 1|RNA reads rep {i}|DNA reads rep {i}|RNA/DNA log ratio rep {i}|
|cCRE ID 2|RNA reads rep {i}|DNA reads rep {i}|RNA/DNA log ratio rep {i}|
...
|------|--------|
|[str]|[float64]|
|cCRE ID 1|Log fold change derived/ancestral rep{i}|
|cCRE ID 2|Log fold change derived/ancestral rep{i}|
