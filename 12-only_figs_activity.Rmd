...
bad_example <- readPNG(file.path(working_dir, "Max_MPRA_run2", "UMI_complexity_histogram.png"),native = T)
...
good_example <- readPNG(file.path(working_dir, "modern_humanMPRA_NPC", "activity_distribution.png"),native = T)
bad_example <- readPNG(file.path(working_dir, "humanMPRA_L1a1_Neurons", "activity_distribution.png"),native = T)
...
good_example <- readPNG(file.path(working_dir, "PMID_38766054_Reilly", "P_value_distribution.png"),native = T)
bad_example <- readPNG(file.path(working_dir, "Max_MPRA_run2", "P_value_distribution.png"),native = T)
...
good_example <- readPNG(file.path(working_dir, "PMID_38766054_Reilly", "cumulative_RNA_reads.png"),native = T)
bad_example <- readPNG(file.path(working_dir, "Max_MPRA_run2", "cumulative_RNA_reads.png"),native = T)
...
good_example <- readPNG(file.path(working_dir, "PMID_38766054_Reilly", "RNA_DNA_ratio_correlation_between_replicates.png"),native = T)
bad_example <- readPNG(file.path(working_dir, "humanMPRA_L1a1", "RNA_DNA_ratio_correlation_between_replicates.png"),native = T)
...
good_example <- readPNG(file.path(working_dir, "PMID_38766054_Reilly", "RNA_DNA_ratio_correlation_between_replicates_with_controls.png"),native = T)
bad_example <- readPNG(file.path(working_dir, "humanMPRA_L1a1", "RNA_DNA_ratio_correlation_between_replicates_with_controls.png"),native = T)
...
good_example <- readPNG(file.path(working_dir, "PMID_38766054_Reilly", "Control_activity_boxplots.png"),native = T)
bad_example <- readPNG(file.path(working_dir, "Max_MPRA_run2", "Control_activity_boxplots.png"),native = T)
