...
knitr::include_graphics("external_figures/fig_1_scheme_v5.png",
                          )
```
...
```{r echo=FALSE, fig.show="hold", out.width="100%"}
knitr::include_graphics("external_figures/fig2.png",
                          )
```
...
```{r echo=FALSE, fig.show="hold", out.width="100%"}
knitr::include_graphics("external_figures/fig4.png",
                          )
```
