...
knitr::include_graphics(c("external_figures/Max_MPRA_run2/Barcodes_per_cCRE.svg",
                          "external_figures/PMID_38766054_Reilly/Barcodes_per_cCRE.svg"))
```
...
```{r echo=FALSE, fig.show="hold", out.width=c("49%","49%")}
knitr::include_graphics(c("external_figures/Max_MPRA_run2/PCR_bias_GC.svg",
                          "external_figures/PMID_38766054_Reilly/PCR_bias_GC.svg"))
```
...
```{r echo=FALSE, fig.show="hold", out.width=c("49%","49%")}
knitr::include_graphics(c("external_figures/thylacine_biorxiv_Gallego_Romero/PCR_bias_G-stretches.svg",
...
```{r echo=FALSE, fig.show="hold", out.width=c("49%","49%")}
knitr::include_graphics(c("external_figures/Max_MPRA_run2/UMIs_per_association.svg",
                          "external_figures/PMID_38766054_Reilly/UMIs_per_association.svg"))
```
...
**Evaluated metrics: BC replicability**<br>
```{r echo=FALSE, fig.show="hold", out.width=c("49%","49%")}
knitr::include_graphics(c("external_figures/Max_MPRA_run2/Retained_cCREs.svg",
                          "external_figures/PMID_38766054_Reilly/Retained_cCREs.svg"))
```
...
```{r echo=FALSE, fig.show="hold", out.width=c("49%","49%")}
knitr::include_graphics(c("external_figures/Max_MPRA_run2/cCREs_per_BC_shuffled.svg",
                          "external_figures/PMID_38766054_Reilly/cCREs_per_BC.svg"))
```
...
knitr::include_graphics(c("external_figures/Max_MPRA_run2/Downsampling_Retained_cCREs.svg",
                          "external_figures/L3a2_281122/Downsampling_Retained_cCREs.svg"))
```
...
**Evaluated metrics: Complexity**<br>
```{r echo=FALSE, fig.show="hold", out.width=c("49%","49%")}
knitr::include_graphics(c("external_figures/L3a2_281122/Downsampling_Barcodes_per_cCRE.svg",
                          "external_figures/Max_MPRA_run2/Downsampling_Barcodes_per_cCRE.svg"))
```
